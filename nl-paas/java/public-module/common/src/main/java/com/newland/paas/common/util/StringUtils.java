 ...
 * @Description: 基于commons-lang-2.6
 * @Funtion List: *
 * @author: wutianwei
 * @version: 1.0.0
 * @Date: 2015/04/01 *
...
public class StringUtils {
    ...
    /**
     * <p>
     * Finds the n-th index within a String, handling <code>null</code>. This method uses
     * {@link String#indexOf(String)}.
     * </p>
     *
     * <p>
     ...
     *
     * <p>
     * No separator is added to the joined String. Null objects or empty string elements are represented by empty
     * strings.
     * </p>
     *
     * <pre>
    ...
    /**
     * <p>
     * Repeat a String <code>repeat</code> times to form a new String, with a String separator injected each time.
     * </p>
     *
     * <pre>
     ...
     * @return
     */
    public static String joinObj(char separator, Object... parts) {
        if (parts != null && parts.length > 0) {
            StringBuffer buf = new StringBuffer();
    ...
    /**
     * 获取字符串中所有的数字 in:12W23 return: [12,23]
     * 
     * @return
     */
    public static List<BigDecimal> getNumberInString(String content) {
    ...
    /**
     * 获取字符串中首个连续数字 in:123454 return: 123454 in:12W23 return: 12
     * 
     * @return
     */
    public static BigDecimal getFirstNumber(String content) {
        Pattern pattern = Pattern.compile("\\d+");
        Matcher matcher = pattern.matcher(content);
        while (matcher.find()) {
    ...
    public static String removeSpecialSymbol(String content) {
        String regEx = "[`~!@#$%^&*()+=|{}';',\\[\\].<>/?~！@#￥%……&*（）——+|{}【】'；：”“’。，、？]";
     ...
     * @return
     */
    public static List<String> getSpecialContent(String content) {
    ...
    /**
     * 1字符只能是大小写字母，数字，下划线，且不能数字开头。 2长度有限制
     * 
     * @param str 输入值
     ...
     * @return
     */
    public static boolean checkStrLegal(String str, Integer minLength, Integer maxLength) {
        String regex = "^[a-zA-Z][a-z0-9A-Z_]{" + minLength + "," + maxLength + "}+$";
        return str.matches(regex);
    }
}