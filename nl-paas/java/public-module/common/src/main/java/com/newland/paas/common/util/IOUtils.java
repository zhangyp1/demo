...
public class IOUtils {
	...
	public static final String LINE_COMMA_SEPARATOR = ",";
	 ...
	 * using {@link IOUtils#toByteArray(InputStream, int)} to read into
	...
	public static byte[] toByteArray(Reader input, String encoding)
			throws IOException {
		return toByteArray(input, IOUtils.toCharset(encoding));
	}
	...
	public static char[] toCharArray(InputStream is, String encoding)
			throws IOException {
		return toCharArray(is, IOUtils.toCharset(encoding));
	}
	...
	public static String toString(InputStream input, String encoding)
			throws IOException {
		return toString(input, IOUtils.toCharset(encoding));
	}
	...
	public static String toString(URI uri, Charset encoding) throws IOException {
		return toString(uri.toURL(), IOUtils.toCharset(encoding));
	}
	...
	public static String toString(URI uri, String encoding) throws IOException {
		return toString(uri, IOUtils.toCharset(encoding));
	}
	...
	public static String toString(URL url, String encoding) throws IOException {
		return toString(url, IOUtils.toCharset(encoding));
	}
	...
	public static String toString(byte[] input, String encoding)
			throws IOException {
		return new String(input, IOUtils.toCharset(encoding));
	}
	...
	public static List<String> readLines(InputStream input, String encoding)
			throws IOException {
		return readLines(input, IOUtils.toCharset(encoding));
	}
	...
	public static InputStream toInputStream(CharSequence input, String encoding)
			throws IOException {
		return toInputStream(input, IOUtils.toCharset(encoding));
	}
	...
	public static InputStream toInputStream(String input, Charset encoding) {
		return new ByteArrayInputStream(input.getBytes(IOUtils
				.toCharset(encoding)));
	}
	...
	public static InputStream toInputStream(String input, String encoding)
			throws IOException {
		byte[] bytes = input.getBytes(IOUtils.toCharset(encoding));
	...
	public static void write(byte[] data, Writer output, Charset encoding)
			throws IOException {
		if (data != null) {
			output.write(new String(data, IOUtils.toCharset(encoding)));
		}
	}
	...
	public static void write(byte[] data, Writer output, String encoding)
			throws IOException {
		write(data, output, IOUtils.toCharset(encoding));
	}
	...
	public static void write(char[] data, OutputStream output, Charset encoding)
			throws IOException {
		if (data != null) {
			output.write(new String(data).getBytes(IOUtils.toCharset(encoding)));
		}
	}
	...
	public static void write(String data, OutputStream output, Charset encoding)
			throws IOException {
		if (data != null) {
			output.write(data.getBytes(IOUtils.toCharset(encoding)));
		}
	}
	...
	public static void write(StringBuffer data, OutputStream output,
			String encoding) throws IOException {
		if (data != null) {
			output.write(data.toString().getBytes(IOUtils.toCharset(encoding)));
		}
	}
	...
	public static void writeLines(Collection<?> lines, String lineEnding,
		...
		Charset cs = IOUtils.toCharset(encoding);
	...
	public static void writeLines(Collection<?> lines, String lineEnding,
		...
		writeLines(lines, lineEnding, output, IOUtils.toCharset(encoding));
	}
	...
	public static void copy(InputStream input, Writer output, String encoding)
			throws IOException {
		copy(input, output, IOUtils.toCharset(encoding));
	}
	 ...
	 */
	public static long copyLarge(Reader input, Writer output,
			final long inputOffset, final long length, char[] buffer)
			throws IOException {
		if (inputOffset > 0) {
			skipFully(input, inputOffset);
		}
	 ...
	 * @since 2.2
	 */
	public static int read(InputStream input, byte[] buffer, int offset,
