...
public class DateUtils {
    ...
    /**
     * funcion getCurrDate purpose 获取今天所在的年月日（格式：yyyy-mm-dd）
     * 
    ...
    public static Date parseDate(String dateStr) {
        ...
        try {
            ...
            throw new RtcException(ErrorCode.BUSERROR_DATE_PARSER, e);
        }
    }
     ...
     * @author guoss
     * @param sDate 当前时间
     * @param iIndex 1:年 2:月 3:日 4:小时 5:分钟 6:秒 iDistance 间隔
     */
    ...
    /**
     * 判断传入的日期是否是当月的第一天 比如传入的日期为20160101，那么返回:true，否则返回:false
     * 
     * @param date
     * @return
     */
     ...
     * @return
     */
    public static Date getCurrentQuarterStartTime(String currentDate) {
        SimpleDateFormat longSdf = new SimpleDateFormat(DATE_FULL_FORMAT);
        SimpleDateFormat shortSdf = new SimpleDateFormat(DATE_SIMP_FORMAT2);
        Calendar c = Calendar.getInstance();
        c.setTime(DateUtils.parseDate(currentDate, DATE_FULL_FORMAT));
     ...
     * @return
     */
    public static Date getCurrentQuarterEndTime(String currentDate) {
        SimpleDateFormat longSdf = new SimpleDateFormat(DATE_FULL_FORMAT);
        SimpleDateFormat shortSdf = new SimpleDateFormat(DATE_SIMP_FORMAT2);
        Calendar c = Calendar.getInstance();
        c.setTime(DateUtils.parseDate(currentDate, DATE_FULL_FORMAT));
