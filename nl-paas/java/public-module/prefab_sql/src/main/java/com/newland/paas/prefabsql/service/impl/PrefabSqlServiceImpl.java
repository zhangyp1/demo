...
/*	@Autowired
	public void setPrefabSqlManager(PrefabSqlManager prefabSqlManager ) {
		this.prefabSqlManager = prefabSqlManager;
	}
*/	
	...
	///*
	public PageBean executeQueryPage(String sqlId, final Map<String, Object> requestMap, PageParams pageParams)
			throws SQLException {
		logInputParam(sqlId, requestMap);// 输入日志跟踪
