...
public class BeanListHandler<T> implements ResultSetHandler<List<T>> {
	//private static LogObj logCache = LogObjFactory.getLogObj(QueryNLRunner.class);
    ...
    public List<T> handle(ResultSet rs) throws SQLException {
    	...
    	//Logger.log("返回记录数:" + list.size());
    	//logCache.info(Constant.LOG_CSF_DBSQL,"返回记录数:" + list.size());
    	return list;
    }
}
