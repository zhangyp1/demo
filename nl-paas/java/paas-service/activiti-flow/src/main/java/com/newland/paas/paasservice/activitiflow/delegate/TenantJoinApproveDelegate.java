 ...
 *
 */
public class TenantJoinApproveDelegate implements JavaDelegate {

    private static final Log LOG = LogFactory.getLogger(TenantJoinApproveDelegate.class);

    @Override
    public void execute(DelegateExecution execution) {
        LOG.info(LogProperty.LOGTYPE_DETAIL, "===TenantJoinApproveDelegate.execution===begin");
        LOG.info(LogProperty.LOGTYPE_DETAIL, "租户加入同意");
        ...
        sysTenantMemberReqVo.setIsAgree("1");
        ...
        LOG.info(LogProperty.LOGTYPE_DETAIL, "租户加入成功!");
        LOG.info(LogProperty.LOGTYPE_DETAIL, "===TenantJoinApproveDelegate.execution===end");
    }
