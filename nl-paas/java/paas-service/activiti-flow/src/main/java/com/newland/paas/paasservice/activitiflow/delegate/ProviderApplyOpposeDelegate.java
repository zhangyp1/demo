 ...
 * @since 2019/2/25
 */
public class ProviderApplyOpposeDelegate implements JavaDelegate {

    private static final Log LOG = LogFactory.getLogger(ProviderApplyOpposeDelegate.class);

    @Override
    public void execute(DelegateExecution execution) {
        LOG.info(LogProperty.LOGTYPE_DETAIL, "===ProviderApplyOpposeDelegate.execution===begin");
        ...
        sysTenantVo.setSupplierStatus(GlbDictConstants.APPROVE_STATUS_APPROVEN.dictCode);
        ...
        LOG.info(LogProperty.LOGTYPE_DETAIL, "租户提供方申请失败!");

        LOG.info(LogProperty.LOGTYPE_DETAIL, "===ProviderApplyOpposeDelegate.execution===end");
    }
